...
- **Subtopic 2. What are computers, then?**: This question is also taken from the first video lecture. This question is asking how broadly the term `computer` can include. Try to list all kinds/types of `computers` (as the `computer` meant in the HCI).
