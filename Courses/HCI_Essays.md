...
- **Subtopic 2. Your ideas?**: Here now, all over the world is facing a serious problem with COVID 19, an infectious virus. You might have some ideas on such as a device, facility, hospital environment/interior, personal protective equipment, software/app showing visual data about any useful information, and so forth, which could support people in health and safety from COVID 19. **Provide your HCI idea(s) that can be helpful to overcome COVID 19. Then, explain in detail how the suggested item interacts with people. Try to visualize your idea about the interaction.**
