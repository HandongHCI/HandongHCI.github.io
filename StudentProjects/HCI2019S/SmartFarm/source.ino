...
#define DHTPIN 4                // Connect the signal pin of DHT11 sensor to digital pin 5
#define DHTTYPE DHT11 
DHT dht(DHTPIN, DHTTYPE);


String apiKey = "L4KWADUA8TRI499K";     // replace with your channel's thingspeak WRITE API key

String ssid="6922";    // Wifi network SSID
