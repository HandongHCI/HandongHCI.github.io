		...
		//		PalmPosition = data.(leap.Hand).StabilizedPalmPosition
         ...
         //   })
            ...
            l.On(leap.HandEvent, func(data interface{}) {
               ...
               //fmt.Println(PalmPosition)
               TelloAD.Store(PalmPosition[0]/10)
               TelloJK.Store(PalmPosition[1]/12-15)
               TelloWS.Store(-(PalmPosition[2]/10))
			  
			  // fmt.Println(PalmPosition[1]/10-10)
			  // fmt.Println(PalmPosition[1]/12-15)
            })
