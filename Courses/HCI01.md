...
Most of the videos I provide, some are gotten from an [online HCI course of GeorgiaTech shared via Udacity](https://classroom.udacity.com/courses/ud400/). I highly recommend you to enroll in GeorgiaTech's course. In that course, you could have a broader understanding of not only the `concept of HCI`, but also `design principles`, `user research methods`, `design process`, `prototyping and evaluation`, and more theoretical information.

But in my HCI course, some theories including `understanding of human`, `design method and process`, `user study`, `ideation and prototyping` are NOT taught, but delivered in my other coursed (e.g., Human Factors and Ergonomics, Product Planning and Development, Ideation and Prototyping). My HCI course is more focusing on practice and project, besides the theories.

If any student who feels a lack of understanding about the theoretical part of HCI, I recommend to take [the online course that GeorgiaTech provides via Udacity](https://classroom.udacity.com/courses/ud400/).
...
- Samsung at CES 2021 (in 9 minutes): We are now almost here.
<div style="position: relative; padding-bottom: 56.25%; padding-top: 0px; margin-bottom: 50px; height: 0;"><iframe src="https://www.youtube.com/embed/U_nAEq53wk4" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"></iframe></div>
(if you want to see the full video of this?: https://www.youtube.com/watch?v=DqXsTtW5VEo. Also, look into the CES 2021, then you may find a lot of interesting HCIs, which can put on your hands VERY SOON!)
...
- What is HCI?
	- [click here and find a video and articles about HCI](https://www.interaction-design.org/literature/topics/human-computer-interaction)

- The birth of HCI
<div style="position: relative; padding-bottom: 56.25%; padding-top: 0px; margin-bottom: 50px; height: 0;"><iframe src="https://www.youtube.com/embed/ar9Jzl3r0gc" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"></iframe></div>

- The history and future of HCI
<div style="position: relative; padding-bottom: 56.25%; padding-top: 0px; margin-bottom: 50px; height: 0;"><iframe src="https://www.youtube.com/embed/t_ZzhadA3DY" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"></iframe></div>

- The advancement of the interface
<div style="position: relative; padding-bottom: 56.25%; padding-top: 0px; margin-bottom: 50px; height: 0;"><iframe src="https://www.youtube.com/embed/CkN85zF33tI" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"></iframe></div>
...
From here, you will need to follow the instruction below to take the necessary lectures.
...
4. Go to **1.3: Exploring HCI (LESSON 3)** and take the following lessons provided via Udacity.
	- HCI Technology: Virtual Reality
	- HCI Technology: Augmented Reality
	- HCI Technology: UbiComp and Wearables
	- HCI Technology: Robotics
	- HCI Technology: Mobile

Of course, most (or all) computer technologies are related to HCI, as the `HCI` means the interaction (or relation) between humans and any kind of `computers`.
...
Also, take the following lessons provided in **1.3: Exploring HCI**.
...
In this course, you will have to think how computers can help/support (or interact with) people, especially in terms of the following domains.
- Home & Human Life
- Healthcare & Safety
- Education & Work
- Smart City
...
Again, take the following lessons provided in **1.3: Exploring HCI**.
...
See the following videos, especially if you want to study HCI in graduate level.
...
- Future Interfaces Group: The next phase of HCI
